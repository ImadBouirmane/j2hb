  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<QuestionsRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<QuestionsRecord> esQsTypeFinalQuestionsRecordList = snapshot.data;
        final esQsTypeFinalQuestionsRecord =
            esQsTypeFinalQuestionsRecordList.isNotEmpty
                ? esQsTypeFinalQuestionsRecordList.first
                : null;
        return Scaffold(
          key: scaffoldKey,
          appBar: AppBar(
                    ...
                    children: [
                      Padding(
                        ...
                        child: FlutterFlowMediaDisplay(
                          path: esQsTypeFinalQuestionsRecord.image,
                      ...
                      Padding(
                        ...
                        child: FlutterFlowAudioPlayer(
                          audio: Audio.network(
                            esQsTypeFinalQuestionsRecord.audio,
                            metas: Metas(
                              id: 'df3hg_-uaydscbh',
                            ),
                          ),
